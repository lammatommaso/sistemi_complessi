...
short Simulator::get_car_number(){
    return _car_number;
}
...
Result Simulator::set_result(Result r){
    _result = r;
}

float Result::set_steps_mean(float s){
    steps_mean = s;
};
float Result::set_steps_sigma(float s){
    steps_sigma = s;
};
float Result::set_stops_mean(float s){
    stops_mean = s;
};
float Result::set_stops_sigma(float s){
    stops_sigma = s;
};
